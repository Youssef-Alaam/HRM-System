...
return [
     ...
     */
    'notifications' => [
        // F12: notifications disabled until Zoho SMTP is wired in Phase 1.
        // Failed/successful backups still log via Laravel's log channel.
        // To re-enable, restore the channel arrays (e.g. => ['mail']).
        'notifications' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             *
             * F12 spec: keep daily backups for 10 days. The longer-tail
             * defaults below (weekly/monthly/yearly) stay; tune in Phase 2.
             */
